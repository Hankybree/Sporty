  ...
  <div class="content">
    ...
    <div id="event">
      <div v-if="$store.state.events.length > 0">
        ...
        <div
          id="type"
        >Detta är ett event av typen: {{ $store.state.events[$store.state.eventIndex].eventSport }}</div>
        ...
        <div id="patch-ui" v-if="$store.state.showPatchUI">
          <input
            id="patch-sport"
            type="text"
            placeholder="Vilken sport?"
            :value="$store.state.events[$store.state.eventIndex].eventSport"
          />
          <input
            id="patch-title"
            type="text"
            placeholder="Ge evenemanget en titel..."
            :value="$store.state.events[$store.state.eventIndex].eventTitle"
          />
          <textarea
            ...
            cols="30"
            rows="10"
            v-model="$store.state.events[$store.state.eventIndex].eventDescription"
          ></textarea>
